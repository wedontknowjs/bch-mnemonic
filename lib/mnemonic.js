...
var Mnemonic = function(data, wordlist) {
  ...
  if (Buffer.isBuffer(data)) {
    ...
    throw new bchLib.errors.InvalidArgument('data', 'Must be a Buffer, a string or an integer');
  }
  ent = ent || 128;
  ...
  if (ent % 32 !== 0 || ent < 128) {
    throw new bchLib.errors.InvalidArgument('ENT', 'Values must be ENT > 128 and ENT % 32 == 0');
  }
...
Mnemonic.prototype.toHDPrivateKey = function(passphrase, network) {
  ...
  return bchLib.HDPrivateKey.fromSeed(seed, network);
};
